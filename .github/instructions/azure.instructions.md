# Azure Coding & Deployment Best Practices
...
See also: `website.instructions.md` for static website conventions, `scss.instructions.md` for SCSS structure, and `python.instructions.md` for Python coding preferences.
